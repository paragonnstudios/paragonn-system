...
public class ComandoSetwarp implements CommandExecutor {
	...
	public boolean onCommand(CommandSender s, Command cmd, String lbl, String[] args) {
		...
		Warp w = new Warp(warp, loc, perm, semPerm, delay, false, true, inicio, fim, false, title, false, subtitle, false, teleportado, teleportadoStaff);
		...
		config.set("EnviarTitle" , false);
		config.set("Title" , title);
		config.set("EnviarSubTitle" , false);
		config.set("SubTitle" , subtitle);
		config.set("EnviarMensagemPlayerTeleportado" , false);
