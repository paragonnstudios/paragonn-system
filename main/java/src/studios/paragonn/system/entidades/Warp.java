...
public class Warp {
	...
	private boolean enviarSubtitle;
	private String subtitle;
	private boolean enviarMensagemPlayerTeleportado;
	...
	public Warp(String nome, String location, String permissao, String semPermissao, int delay, boolean delayVip,
				...
				boolean enviarSubtitle, String subtitle, boolean enviarMensagemPlayerTeleportado, String mensagemPlayerTeleportado, String mensagemPlayerTeleportadoStaff) {
		...
		this.enviarSubtitle = enviarSubtitle;
		this.subtitle = subtitle.replace('&', '§');
		this.enviarMensagemPlayerTeleportado = enviarMensagemPlayerTeleportado;
	...
	public boolean enviarSubtitle() {
		return enviarSubtitle;
	}
	...
	public boolean enviarMensagemPlayerTeleportado() {
		return enviarMensagemPlayerTeleportado;
	}
