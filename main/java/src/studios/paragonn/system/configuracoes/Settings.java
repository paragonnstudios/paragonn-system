...
public class Settings {
	...
	public static void loadSettings() {
		...
		if (!config.contains("Comando-Do-Botao-Voltar")) {
			...
			try {
				java.io.File arquivo = new java.io.File(studios.paragonn.system.Main.get().getDataFolder() + java.io.File.separator + "settings.yml");
				config.save(arquivo);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		Comando_Do_Botao_Voltar = config.getString("Comando-Do-Botao-Voltar", "kits").replace("/", "");
	}
