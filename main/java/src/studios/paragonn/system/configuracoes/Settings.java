package studios.paragonn.system.configuracoes;
...
public class Settings {
    ...
    public static String Comando_Do_Botao_Voltar;

    public static void loadSettings() {
        FileConfiguration config = ConfigManager.getConfig("settings");
        AtivarAddons_MassiveFactions = config.getBoolean(
            "AtivarAddons.MassiveFactions"
        );
        ...
        Bloquear_Subir_Em_Veiculos = config.getBoolean(
            "Bloquear-Subir-Em-Veiculos"
        );
        Bloquear_NameTag = config.getBoolean("Bloquear-NameTag");
        Bloquear_Passar_Da_Borda = config.getBoolean(
            "Bloquear-Passar-Da-Borda"
        );
        Bloquear_Subir_No_Teto_Nether = config.getBoolean(
            "Bloquear-Subir-No-Teto-Nether"
        );
        EnderPearl_Cooldown_Ativar = config.getBoolean(
            "EnderPearl-Cooldown.Ativar"
        );
        EnderPearl_Cooldown_Cooldown = config.getLong(
            "EnderPearl-Cooldown.Cooldown"
        );
        Bloquear_Abrir_Containers_Ativar = config.getBoolean(
            "Bloquear-Abrir-Containers.Ativar"
        );
        Bloquear_Abrir_Containers_Containers = Utils.listToListEnum(
            InventoryType.class,
            config.getStringList("Bloquear-Abrir-Containers.Containers")
        );
        Bloquear_Shift_Em_Containers_Ativar = config.getBoolean(
            "Bloquear-Shift-Em-Containers.Ativar"
        );
        Bloquear_Shift_Em_Containers_Containers = Utils.listToListEnum(
            InventoryType.class,
            config.getStringList("Bloquear-Shift-Em-Containers.Containers")
        );
        Bloquear_Money_Invalido = config.getBoolean("Bloquear-Money-Invalido");
        Comandos_Que_Envolvem_Money = Utils.listToLowerCase(
            config.getStringList("Comandos-Que-Envolvem-Money")
        );
        Bloquear_Congelar_Agua = config.getBoolean("Bloquear-Congelar-Agua");
        Bloquear_Derreter_Gelo_E_Neve = config.getBoolean(
            "Bloquear-Derreter-Gelo-E-Neve"
        );
        Desativar_Mobs_Naturais = config.getBoolean("Desativar-Mobs-Naturais");
        Desativar_Propagacao_Do_Fogo = config.getBoolean(
            "Desativar-Propagacao-Do-Fogo"
        );
        Desativar_Queda_Das_Folhas = config.getBoolean(
            "Desativar-Queda-Das-Folhas"
        );
        Desativar_Queda_Da_Areia = config.getBoolean(
            "Desativar-Queda-Da-Areia"
        );
        Desativar_Queda_Da_Bigorna = config.getBoolean(
            "Desativar-Queda-Da-Bigorna"
        );
        Desativar_Flow_Da_Agua_E_Lava = config.getBoolean(
            "Desativar-Flow-Da-Agua-E-Lava"
        );
        Desativar_Chuva = config.getBoolean("Desativar-Chuva");
        Delay_Para_Teleportar_Comandos = config.getLong(
            "Delay-Para-Teleportar-Comandos"
        );
        Delay_Para_Divulgar =
            config.getLong("Delay-Para-Divulgar") * 1000L * 60L;
        Bloquear_Mobs_De_Pegarem_Fogo_Para_O_Sol = config.getBoolean(
            "Bloquear-Mobs-De-Pegarem-Fogo-Para-O-Sol"
        );
        Bloquear_Mobs_De_Pegarem_Itens_Do_Chao = config.getBoolean(
            "Bloquear-Mobs-De-Pegarem-Itens-Do-Chao"
        );
        ...
        Desativar_Dano_Do_EnderDragon = config.getBoolean(
            "Desativar-Dano-Do-EnderDragon"
        );
        Desativar_Dano_Do_Ghast = config.getBoolean("Desativar-Dano-Do-Ghast");
        Desativar_Dano_Do_Wither = config.getBoolean(
            "Desativar-Dano-Do-Wither"
        );
        Desativar_Fome_Nos_Mundos = config.getBoolean(
            "Desativar-Fome-Nos-Mundos"
        );
        Desativar_Mensagem_De_Entrada = config.getBoolean(
            "Desativar-Mensagem-De-Entrada"
        );
        Desativar_Mensagem_De_Morte = config.getBoolean(
            "Desativar-Mensagem-De-Morte"
        );
        Desativar_Mensagem_De_Saida = config.getBoolean(
            "Desativar-Mensagem-De-Saida"
        );
        Entrar_No_Spawn_Ao_Logar = config.getBoolean(
            "Entrar-No-Spawn-Ao-Logar"
        );
        Bloquear_Criar_Portal = config.getBoolean("Bloquear-Criar-Portal");
        Bloquear_Teleport_Por_Portal_Ativar = config.getBoolean(
            "Bloquear-Teleport-Por-Portal.Ativar"
        );
        Bloquear_Teleport_Por_Portal_NetherPortal = config.getBoolean(
            "Bloquear-Teleport-Por-Portal.NetherPortal"
        );
        Bloquear_Teleport_Por_Portal_EndPortal = config.getBoolean(
            "Bloquear-Teleport-Por-Portal.EndPortal"
        );
        ...
        Limite_De_Players = config.getInt(
            "Limitador-De-Players.Limite-De-Players"
        );
        Kickar_Sem_Vip = config.getBoolean(
            "Limitador-De-Players.Kickar-Sem-Vip"
        );
        Tempo_Para_Ser_Kick = config.getLong(
            "Limitador-De-Players.Tempo-Para-Ser-Kickado-Apos-Aviso"
        );
        Invencibilidade_Ao_Teleportar = config.getBoolean(
            "Invencibilidade-Ao-Teleportar.Ativar"
        );
        Tempo_De_Invencibilidade_Ao_Teleportar = config.getLong(
            "Invencibilidade-Ao-Teleportar.Tempo-De-Invencibilidade-Ao-Teleportar"
        );
        Dropar_Cabeca_Ao_Morrer = config.getBoolean(
            "Dropar-Cabeca-Ao-Morrer.Ativar"
        );
        Chance_De_Dropar_Cabeca_Ao_Morrer = config.getInt(
            "Dropar-Cabeca-Ao-Morrer.Chance-De-Dropar-Cabeca-Ao-Morrer"
        );
        Sistema_De_Fly_Para_Players = config.getBoolean(
            "Sistema-De-Fly-Para-Players"
        );
        Mundos_Onde_Pode_Usar_Fly = config.getStringList(
            "Mundos-Onde-Pode-Usar-Fly"
        );
        Mensagem_De_Boas_Vindas_Ativar = config.getBoolean(
            "Mensagem-De-Boas-Vindas.Ativar"
        );
        Mensagem_De_Boas_Vindas_Mensagem = Utils.colorizeListString(
            config.getStringList("Mensagem-De-Boas-Vindas.Mensagem")
        );
        Title_De_Boas_Vindas_Ativar = config.getBoolean(
            "Title-De-Boas-Vindas.Ativar"
        );
        Title_De_Boas_Vindas_Titulo = getString(
            config,
            "Title-De-Boas-Vindas.Titulo"
        );
        Title_De_Boas_Vindas_Subtitulo = getString(
            config,
            "Title-De-Boas-Vindas.Subtitulo"
        );
        Ativar_Camarote_Para_Os_Sem_Vip = config.getBoolean(
            "Ativar-Camarote-Para-Os-Sem-Vip"
        );
        ...
        Lista_Dos_Comandos_Bloqueados = Utils.listToLowerCase(
            config.getStringList("Lista-Dos-Comandos-Bloqueados")
        );
        Bloquear_Crafts = config.getBoolean("Bloquear-Crafts");
        Lista_Dos_Crafts_Bloqueados = config.getIntegerList(
            "Lista-Dos-Crafts-Bloqueados"
        );
        Bloquear_Palavras_Em_Placas_Ativar = config.getBoolean(
            "Bloquear-Palavras-Em-Placas.Ativar"
        );
        Bloquear_Todas_As_Palavras = config.getBoolean(
            "Bloquear-Palavras-Em-Placas.Bloquear-Todas-As-Palavras"
        );
        Bloquear_Apenas_Algumas_Palavras = config.getBoolean(
            "Bloquear-Palavras-Em-Placas.Bloquear-Apenas-Algumas-Palavras"
        );
        Lista_Das_Palavras_Bloqueadas = Utils.listToLowerCase(
            config.getStringList(
                "Bloquear-Palavras-Em-Placas.Lista-Das-Palavras-Bloqueadas"
            )
        );
        Bloquear_Nicks_Improprios = config.getBoolean(
            "Bloquear-Nicks-Improprios"
        );
        Nicks_Bloqueados = Utils.listToLowerCase(
            config.getStringList("Nicks-Bloqueados")
        );
        mcTopTag_Tempo_De_Checagem = config.getLong(
            "mcTopTag.Tempo-De-Checagem"
        );
        mcTopTag_Tag = config
            .getString("mcTopTag.Tag", "§9[*] ")
            .replace('&', '§');
        magnataTag_Tempo_De_Checagem = config.getLong(
            "magnataTag.Tempo-De-Checagem"
        );
        magnataTag_Tag = config
            .getString("magnataTag.Tag", "§2[$] ")
            .replace('&', '§');
        try {
            CorAutomatica = Utils.mapToMapString(
                config.getConfigurationSection("CorAutomatica").getValues(true)
            );
        } catch (Throwable e) {
            CorAutomatica = new HashMap<>();
        }
        ...
        Reproduzir_Som_No_Anuncio = config.getBoolean(
            "Reproduzir-Som-No-Anuncio"
        );
        Som_Do_Anuncio = Utils.tryLoadSound(
            "LEVEL_UP",
            "ENTITY_PLAYER_LEVELUP"
        );
        Lista_De_Anuncios = Utils.colorizeListString(
            config.getStringList("Lista-De-Anuncios")
        );
        Anunciar_Morte = config.getBoolean("Anunciar-Morte");
        Anuncios_Mostrar_Para_Quem_Morreu = config.getBoolean(
            "Anuncios.Mostrar-Para-Quem-Morreu"
        );
        Anuncios_Mensagem_Para_Defunto = getString(
            config,
            "Anuncios.Mensagem-Para-Defunto"
        );
        Anuncios_Mostrar_Para_Quem_Matou = config.getBoolean(
            "Anuncios.Mostrar-Para-Quem-Matou"
        );
        Anuncios_Mensagem_Para_Matador = getString(
            config,
            "Anuncios.Mensagem-Para-Matador"
        );
        Anuncios_Mostrar_Para_Todo_Servidor = config.getBoolean(
            "Anuncios.Mostrar-Para-Todo-Servidor"
        );
        Anuncios_Mensagem_Para_Todos = getString(
            config,
            "Anuncios.Mensagem-Para-Todos"
        );
        ScoreBoard_Ativar = config.getBoolean("ScoreBoard.Ativar");
        ScoreBoard_Titulo = config
            .getString("ScoreBoard.Titulo", "§cSem titulo")
            .replace('&', '§');
        ScoreBoard_Linhas = Utils.colorizeListString(
            config.getStringList("ScoreBoard.Linhas")
        );
        ...
        Tempo_Para_Expirar_Solicitacao_Tpa = config.getLong(
            "Tempo-Para-Expirar-Solicitacao-Tpa"
        );
        Tempo_Para_Poder_Enviar_Outra_Solicitacao_Tpa = config.getLong(
            "Tempo-Para-Poder-Enviar-Outra-Solicitacao-Tpa"
        );
        Som_Slime_Esta = Utils.tryLoadSound(
            "SLIME_WALK2",
            "ENTITY_SLIME_SQUISH"
        );
        Som_Slime_Nao_esta = Utils.tryLoadSound(
            "SLIME_ATTACK",
            "ENTITY_SLIME_ATTACK"
        );
        Bloquear_Quebrar_Plantacoes_Pulando = config.getBoolean(
            "Bloquear-Quebrar-Plantacoes-Pulando"
        );
        Deletar_Comandos = config.getBoolean("Deletar-Comandos");
        Lista_Dos_Comandos_Deletados = Utils.listToLowerCase(
            config.getStringList("Lista-Dos-Comandos-Deletados")
        );
        Bloquear_Explodir_Itens = config.getBoolean("Bloquear-Explodir-Itens");
        Bloquear_Kick_Por_Duplo_Login = config.getBoolean(
            "Bloquear-Kick-Por-Duplo-Login"
        );
        Bloquear_Kick_Por_Duplo_Login_Super = config.getBoolean(
            "Super-Bloquear-Kick-Por-Duplo-Login"
        );
        Mundos_Sem_Sistema_De_Back = config.getStringList(
            "Mundos-Sem-Sistema-De-Back"
        );
        ...
        try {
            Grupos_De_Permissoes_De_Homes = Utils.mapToMapInt(
                config
                    .getConfigurationSection("Grupos-De-Permissoes-De-Homes")
                    .getValues(true)
            );
        } catch (Throwable e) {
            Grupos_De_Permissoes_De_Homes = new HashMap<>();
        }
        Delay_Padrao_Warps = config.getInt("Delay-Padrao-Warps", 5);
        Comandos_Com_Cooldown = config.getBoolean("Comandos-Com-Cooldown");
        try {
            Lista_Dos_Comandos_Com_Cooldown = Utils.listSplitToMapMillis(
                config.getStringList("Lista-Dos-Comandos-Com-Cooldown"),
                ":"
            );
        } catch (Throwable e) {
            Lista_Dos_Comandos_Com_Cooldown = new HashMap<>();
        }
        Comandos_Com_Delay = config.getBoolean("Comandos-Com-Delay");
        try {
            Lista_Dos_Comandos_Com_Delay = Utils.listSplitToMapMillis(
                config.getStringList("Lista-Dos-Comandos-Com-Delay"),
                ":"
            );
        } catch (Throwable e) {
            Lista_Dos_Comandos_Com_Delay = new HashMap<>();
        }
        Executar_Comandos_No_Primeiro_Login = config.getBoolean(
            "Executar-Comandos-No-Primeiro-Login"
        );
        try {
            Lista_Dos_Comandos_Executados_No_Primeiro_Login =
                Utils.colorizeListString(
                    config.getStringList(
                        "Lista-Dos-Comandos-Executados-No-Primeiro-Login"
                    )
                );
        } catch (Throwable e) {
            Lista_Dos_Comandos_Executados_No_Primeiro_Login = new ArrayList<>();
        }
        Listar_Warps_Caso_Nao_Exista = config.getBoolean(
            "Listar-Warps-Caso-Nao-Exista",
            true
        );
        Listar_Kits_Caso_Nao_Exista = config.getBoolean(
            "Listar-Kits-Caso-Nao-Exista",
            true
        );
        if (!config.contains("Comando-Do-Botao-Voltar")) {
            config.set("Comando-Do-Botao-Voltar", "kits");
            try {
                java.io.File arquivo = new java.io.File(
                    studios.paragonn.system.Main.get().getDataFolder() +
        ...
        Comando_Do_Botao_Voltar = config
            .getString("Comando-Do-Botao-Voltar", "kits")
            .replace("/", "");
    }
    ...
    private static String getString(FileConfiguration config, String path) {
        return config
            .getString(
                path,
                "§cNão foi possivel localizar a mensagem '§e" +
                    path +
                    "§c' do arquivo §nsettings.yml§c."
            )
            .replace('&', '§');
    }
}
